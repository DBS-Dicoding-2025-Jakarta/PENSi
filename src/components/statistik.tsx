...
const PensiStatistics: React.FC = () => {
    return (
        <section className="container mx-auto py-20 px-4 md:px-6">
            {/* Header Section */}
            <header className="mb-6">
                <h3 className="text-green-600 font-medium mb-2">Statistik dan Dampak Sosial</h3>
                <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
                    Dampak Nyata dari PENSi<br />untuk Masyarakat Indonesia
                </h1>
                <p className="text-gray-600 mb-12">
                    Data berbicara—lihat bagaimana PENSi telah membantu ribuan orang<br />
            ...
            <div className="flex flex-col md:flex-row items-center">
                ...
                <section className="w-full md:w-1/2 pr-0 md:pr-8" aria-label="Statistik Pengguna">
                    ...
                    <article className="mb-12">
                        <h2 className="text-5xl md:text-6xl font-bold mb-2">{'< 5 Menit'}</h2>
                        <p className="text-gray-600">
...
export default PensiStatistics;
