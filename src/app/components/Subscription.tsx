...
const Subscription: React.FC = () => {
  return (
    <div className="mx-auto flex flex-col ">
      ...
      <section
        id="kontak"
        className="bg-green-500 text-white py-8 px-6 md:px-12 lg:px-24"
      >
      ...
      <div className="py-5 bg-white border-opacity-20 flex flex-wrap justify-center text-center">
        <p className="text-sm text-cyan-900">
          Copyright @PENSi 2025. All Rights Reserved.
        </p>
      </div>
    </div>
  );
