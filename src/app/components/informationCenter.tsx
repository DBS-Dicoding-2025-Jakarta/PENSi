                ...
                <main className="flex flex-col gap-8">
                    ...
                    <Link href="/blog/PERENCANAAN">
                        <div className="flex flex-col lg:flex-row bg-primary/10 rounded-lg overflow-hidden cursor-pointer">
                            <div className="p-8 lg:w-1/2">
                                <p className="text-primary uppercase font-medium text-sm mb-3">PERENCANAAN</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <Link href="/blog/BESTPRACTICES">
                            <div className="bg-primary/10 rounded-lg overflow-hidden flex flex-col h-full cursor-pointer">
                                <div className="p-6 flex-grow">
                                    <p className="text-primary uppercase font-medium text-sm mb-3">BEST PRACTICES</p>
                        ...
                        <Link href="/blog/FONDASIKEUANGAN">
                            <div className="bg-primary/10 rounded-lg overflow-hidden flex flex-col h-full cursor-pointer">
                                <div className="p-6 flex-grow">
                                    <p className="text-primary uppercase font-medium text-sm mb-3">FONDASI KEUANGAN</p>
                                    <h3 className="text-xl font-bold">
                        ...
                        <Link href="/blog/GAYAHIDUPPENSIUN">
                            <div className="bg-primary/10 rounded-lg overflow-hidden flex flex-col h-full cursor-pointer">
                                <div className="p-6 flex-grow">
                                    <p className="text-primary uppercase font-medium text-sm mb-3">GAYA HIDUP PENSIUN</p>
                                    <h3 className="text-xl font-bold">
